...
// Slide 3: Typography
{
  ...
  addTitle(s, 'Use one display family and one body family.', 0.75, 1.24, 6.1)
  addBody(s, 'Keep titles, labels, and key numbers in Space Grotesk. Keep paragraphs and supporting detail in Inter.', 0.75, 1.92, 6.0, 0.4, { fontSize: 13 })
  addPanel(s, 0.75, 2.75, 5.9, 3.95)
  addTitle(s, 'Space Grotesk', 1.05, 3.02, 3.5, 22, 0.5)
  addBody(s, 'Display / headings', 1.05, 3.42, 2.2, 0.18, { fontSize: 11, color: C.blue, bold: true })
  addBody(s, 'Use for slide titles, section labels, metrics, and the wordmark.', 1.05, 3.72, 4.8, 0.34, { fontSize: 11.5 })
  addBulletList(s, ['Bold for titles', 'Uppercase for small labels', 'Keep the wordmark tracked and controlled'], 1.05, 4.28, 4.6, 0.46)
  addPanel(s, 6.95, 2.75, 5.65, 3.95)
  addBody(s, 'Inter', 7.25, 3.02, 1.8, 0.24, { fontSize: 20, color: C.text, bold: true })
  addBody(s, 'Body / supporting text', 7.25, 3.42, 2.6, 0.18, { fontSize: 11, color: C.blue, bold: true })
  addBody(s, 'Use for paragraphs, bullets, notes, captions, and supporting detail.', 7.25, 3.72, 4.5, 0.34, { fontSize: 11.5 })
  addBulletList(s, ['Regular 400 is the default', 'Use muted text for secondary reading', 'Keep line-height calm and readable'], 7.25, 4.28, 4.1, 0.46)
}
